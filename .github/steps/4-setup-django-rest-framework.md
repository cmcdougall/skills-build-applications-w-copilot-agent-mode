...
> 🪧 **Note:** 
- Make sure to replace effective-funicular-gxj5rvg4rxwc977j with your codespace name.
...
> 2. Update #file:octofit-tracker/backend/octofit_tracker/views.py to replace the return for the REST API URL endpoints with the codespace URL https://effective-funicular-gxj5rvg4rxwc977j-8000.app.github.dev for Django and avoid certificate HTTPS issues.
> 3. Make sure the Django backend works on effective-funicular-gxj5rvg4rxwc977j-8000.app.github.dev and localhost:8000.
